...
1. Run a regression removing the most problematic data in terms of missing variables and see how the results of the other predictors change. 
2. Explain the relationship that you observe in your "reduced" model. 
3. Graph the most important (in your opinion) relationships in a scatter plot. 
4. Upload everything to the github student folder. (optional)
